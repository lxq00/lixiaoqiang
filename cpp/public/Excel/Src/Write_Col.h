...
public:
	...
	///设置数据，内容
	shared_ptr<WorkBook::Cell> setData(uint32_t rowNum, const shared_ptr<WorkBook::Value>& val);
	shared_ptr<WorkBook::Cell> setData(uint32_t rowNum, const WorkBook::Value& val);
