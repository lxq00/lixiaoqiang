...
HZIP CreateZipHandle(FILE* h, const char *password);
...
ZRESULT ZipAddHandle(HZIP hz,const TCHAR *dstzn, FILE* h);
ZRESULT ZipAddHandle(HZIP hz,const TCHAR *dstzn, FILE* h, unsigned int len);
