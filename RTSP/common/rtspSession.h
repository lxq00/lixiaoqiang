...
public:
	...
	bool sendMedia(bool isvideo, uint32_t timestmap, const RTSPBuffer& data, bool mark)
	{
		if (!rtp) return false;
...
private:
	virtual void rtpDataCallback(bool isvideo, uint32_t timestmap, const RTSPBuffer& data, bool mark) = 0;
