...
# 生成库的设置
# 定义库的文件目录
	SRCS_PATH =  Src/opensource/eXosip2/src Src/opensource/osip2/src Src/opensource/osipparser2/src Src
	
# 库的名称
   SHARDLIB_NAME = 
   STATICLIB_NAME = SIPStack
...
# 子目录编译需要的目录
   SUB_INCLUDE = -I Src/opensource/Include
